...
import com.heshidai.cdzmerchant.utils.SpecialCalendarutil;
...
//    }
    ...
    public class CalendarAdapter extends SimpleBaseAdapter {
        ...
        public View getItemView(final int position, View convertView, final ViewHolder viewHolder) {
            ...
            weekView.setText(StringUtil.getWeekString().get(position));
            ...
            dayView.setOnClickListener(new OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    HLog.e("myCalender", calendar.year + "年" + calendar.month + "月" + calendar.day);
